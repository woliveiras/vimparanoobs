...
![VIM](./images/vim-hackudo.gif)


Vai te achar um monstro das hackeragem, o próprio [Kevin Mitnick](https://en.wikipedia.org/wiki/Kevin_Mitnick).

Eu decidi testar o VIM quando, em um [Meetup](meetup.com/), vi um cara escrever uma linha de texto `sufocar cara_da_frente`, digitar `:wq` e o cara que estava sentado na frente dele começou a ficar sem ar!
